...
class JobApplication(Base):
    ...
    application_date: Column[date] = Column(Date, nullable=True, index=True)  # Added index
    deadline: Column[date] = Column(Date, nullable=True)
    ...
    recruiter_name: Column[str] = Column(String, nullable=True)
    recruiter_email: Column[str] = Column(String, nullable=True)
    recruiter_linkedin: Column[str] = Column(String, nullable=True)
    recruiter_phone: Column[str] = Column(String, nullable=True)

    # Referral tracking fields
    referral_name: Column[str] = Column(String, nullable=True)
    referral_relationship: Column[str] = Column(String, nullable=True)

    # Application source and response tracking
    application_source: Column[str] = Column(
        String, nullable=True, index=True
    )  # LinkedIn, Indeed, Company Site, Referral, etc.
    response_date: Column[datetime] = Column(DateTime, nullable=True)
