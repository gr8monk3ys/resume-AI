...
class CompanyFilter(Base):
    ...
    filter_type = Column(
        SQLEnum(CompanyFilterType),
        nullable=False,
        default=CompanyFilterType.BLACKLIST
    )
...
class KeywordFilter(Base):
    ...
    filter_type = Column(
        SQLEnum(KeywordFilterType),
        nullable=False,
        default=KeywordFilterType.EXCLUDE
    )
    applies_to = Column(
        SQLEnum(KeywordAppliesTo),
        nullable=False,
        default=KeywordAppliesTo.BOTH
    )
    created_at = Column(DateTime, default=datetime.utcnow)
