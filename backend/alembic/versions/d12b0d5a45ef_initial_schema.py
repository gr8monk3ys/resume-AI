...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_job_applications_profile_id"), "job_applications", ["profile_id"], unique=False
    )
    op.create_index(
        op.f("ix_job_applications_status"), "job_applications", ["status"], unique=False
    )
    op.create_index(
        op.f("ix_job_applications_application_date"),
        "job_applications",
        ["application_date"],
        unique=False,
    )
    op.create_index(
        op.f("ix_job_applications_updated_at"), "job_applications", ["updated_at"], unique=False
    )
    op.create_index(
        op.f("ix_job_applications_application_source"),
        "job_applications",
        ["application_source"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_job_applications_profile_updated",
        "job_applications",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["job_application_id"], ["job_applications.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(["profile_id"], ["profiles.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_index(
        op.f("ix_career_journal_profile_id"), "career_journal", ["profile_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "filter_type",
            sa.Enum("BLACKLIST", "WHITELIST", name="companyfiltertype"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_company_filters_user_id"), "company_filters", ["user_id"], unique=False
    )
    op.create_index(
        op.f("ix_company_filters_company_name"), "company_filters", ["company_name"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "filter_type", sa.Enum("EXCLUDE", "REQUIRE", name="keywordfiltertype"), nullable=False
        ),
        sa.Column(
            "applies_to",
            sa.Enum("TITLE", "DESCRIPTION", "BOTH", name="keywordappliesto"),
            nullable=False,
        ),
        sa.Column("created_at", sa.DateTime(), nullable=True),
        sa.ForeignKeyConstraint(["user_id"], ["users.id"], ondelete="CASCADE"),
    ...
    op.create_index(
        op.f("ix_keyword_filters_user_id"), "keyword_filters", ["user_id"], unique=False
    )
    op.create_index(
        op.f("ix_keyword_filters_keyword"), "keyword_filters", ["keyword"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "question_type",
            sa.Enum("TEXT", "NUMBER", "SELECT", "BOOLEAN", name="questiontype"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_application_questions_id"), "application_questions", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_application_questions_user_id"), "application_questions", ["user_id"], unique=False
    )
    op.create_index(
        op.f("ix_application_questions_question_pattern"),
        "application_questions",
        ["question_pattern"],
        unique=False,
    )
    op.create_index(
        op.f("ix_application_questions_category"),
        "application_questions",
        ["category"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_application_questions_question_pattern"), table_name="application_questions"
    )
