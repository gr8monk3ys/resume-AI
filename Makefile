.PHONY: backend frontend dev test test-e2e lint clean help \
        ...
        db-migrate db-upgrade db-downgrade install setup
...
setup:
	@echo "Setting up ResuBoost AI for development..."
	@if [ ! -f .env ]; then \
		...
		echo "DATABASE_URL=sqlite:///./data/resume_ai.db" >> .env; \
		echo "" >> .env; \
		echo "# Uncomment and set a real provider for AI features:" >> .env; \
	...
	@echo "AI features use mock responses by default."
	@echo "Set OPENAI_API_KEY in .env for real AI."
