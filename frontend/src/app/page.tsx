    ...
    async function fetchDashboardData() {
      ...
      try {
        const [resumes, jobs, coverLetters, jobStats] = await Promise.all([
          resumesApi.list(tokens.access_token).catch(() => [] as Resume[]),
          jobsApi.list(tokens.access_token).catch(() => [] as JobApplication[]),
          coverLettersApi.list(tokens.access_token).catch(() => [] as CoverLetter[]),
