...
/**
 * Get demo credentials from environment variables only
 * Returns null if not configured, preventing hardcoded credentials in the bundle
 */
function getDemoCredentials(): { username: string; password: string } | null {
...
export function LoginPageClient() {
  ...
  useEffect(() => {
    const shouldShow = shouldShowDemoCredentials()
    const credentials = getDemoCredentials()
    // Only show demo section if both flag is enabled AND credentials are configured
    setShowDemoCredentials(shouldShow && credentials !== null)
